...
let EventsService = class EventsService {
    constructor(db) {
        this.eventsColl = db.collection('events', (ref) => ref.orderBy('date')); //TO DO: some condition to be fulfilled, return only events that are now time to future
        this.events = this.eventsColl.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((actions) => {
